...
$bloque3 = <<<EOF
   ...
   <table style="font-size:9px; padding:5px 10px; text-align:center">
    ...
    <tr>
      ...
      <td style="border: 1px solid #666; background-color:white; width:50px;  text-align:center">Descripción</td>
...
$bloque4 = <<<EOF
  ...
  <table style="font-size:8px; padding:5px 10px; text-align:center">
    ...
    <tr>
      ...
      <td style="border: 1px solid #666; color:#333; background-color:white; width:50px; text-align:justify">
        $item1[descripcion]
      </td>
...
$pdf->Output('consulta_documento.pdf');
