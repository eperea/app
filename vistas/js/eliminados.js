...
var idoculto1 = $("#idoculto1").val();

$('.tablaUnidades1').DataTable( {
        "ajax": "ajax/datatable-unidadeselim.ajax.php?idoculto1="+idoculto1,
        "deferRender": true,
  "retrieve": true,
  "processing": true,
   "language": {
...
EDITAR UNIDAD
=============================================*/
$(".tablaUnidades1").on("click", "button.btnEditarUnidad", function(){
  ...
  //DEPARTAMENTO
           ...
           $.ajax({
              ...
              success:function(respuesta){
                  ...
                  $("#editarnuevaSerie_id").html(respuesta["idSeries"] + " " + respuesta["nombreSerie"]);
           ...
           var dotosCaja = new FormData();


           dotosCaja.append("idCaja",respuesta["CAJA_idCaja"]);
        ...
        $("#editarnuevaCaja").val(respuesta["CAJA_idCaja"]);
...
ELIMINSAR SERIE
=============================================*/
$(".tablaUnidades1").on("click", "button.btnEliminarUnidad", function(){
