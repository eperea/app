  ...
  <div class="box">
    ...
    <form method="post" action="extensiones/tcpdf/pdf/carpetas.php" target="_blank"  >
              ...
              <div class="btn-group" style="padding-left: 10px;">
                   ...
                   <a class="btn btn-info" href="extensiones/exportar/pdf.php" aria-label="reporte xls" title="Descargar reporte en Excel">
                  ...
                  <button class="btn btn-info" title="Descargar reporte en pdf" >                    
    ...
    <table class="table table-bordered table-striped dt-responsive tablaUnidades" style="width:100%">
          ...
          <div class="box-body">
           ...
           <div class="form-group">
            ...
            <div class="input-group">
              ...
              <select class="form-control mibuscador" style="width: 100%;"  name="nuevaSerie_id" title="Elija la serie a la que le pertenece la unidad documental">
                ...
                foreach ($categorias as $key => $value) {
                 ...
                 echo '<option value="'.$value["idSeries"].'">'. $value["codigo_serie"], " - ",  $value["nombreSerie"].'</option>';
...
<?php
                    ...
                    $ventas = ControladorUnidades::ctrMostrarUnidades($item, $valor);

                    if(!$ventas){

                      echo '<input type="text" class="form-control" name="nuevaUnidad" value="10001" readonly>';
                      ...
                      $codigo = $value["codigo1"] + 1;



                      echo '<input type="text" class="form-control" name="nuevaUnidad" value="'.$codigo.'" >';
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input type="number" class="form-control input-lg" name="nuevaSubserie" title="Ingresar codigo de la unidad documental" >
...
<?php
                    ...
                    if(!$ventas){
                      ...
                      echo '<input type="text" class="form-control" name="nuevaUnidad1" value="10001" readonly>';
                      ...
                      echo '<input type="text" class="form-control" name="nuevaUnidad1" value="'.$codigo.'" readonly>';
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control input-lg" name="uni_rango" title="Ingresar codigo caja" >
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control input-lg" name="uni_rango1" title="Ingresar codigo caja" >
    ...
    <div class="form-group">
     ...
     <div class="input-group">
      ...
      <textarea class="form-control" name="nuevaObservacion" rows="2" value="SIN OBSERVACIONES" placeholder="Ingresar Observacion...">SIN OBSERVACIONES</textarea>
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <select class="form-control mibuscador" style="width: 100%;"  name="nuevaEmpresa" title="Elija la empresa a la que le pertenece la unidad documental">
 ...
 <div class="form-group">
  ...
  <div class="input-group">
    ...
    <select class="form-control mibuscador" style="width: 100%;"  name="nuevaSede" title="Elija la sede a la que le pertenece la unidad documental" >
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <select class="form-control mibuscador" style="width: 100%;"   name="nuevaDepartamento" title="Elija el departamento al que le pertenece la unidad documental">
...
<div class="form-group">
  ...
  <label>Caja</label>
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control mibuscador" style="width: 100%;"  name="uni_caja" title="Elija la caja en donde se conservarà la unidad documental en el archivo" >
                    ...
                    <?php
                      ...
                      echo '<option value="'.$value["idCaja"].'">'. $value["caja_prefijo"] . ' ' .  $value["caja_codigo"] . ' ' . $value["caja_sufijo"].'</option>';
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="number" class="form-control input-lg" id="editarnuevaSubserie" name="editarnuevaSubserie" title="Ingresar codigo de la unidad documental" >
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control input-lg" name="editarnuevaUnidad1" id="editarnuevaUnidad1" title="Ingresar codigo de la unidad documental" readonly>
