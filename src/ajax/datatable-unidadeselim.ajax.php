...
class TablaUnidadeselim{

/*=============================================
MOSTRAR TABLA UNIDADES
=============================================*/

			public function mostrarTablaUnidadeselim(){        
		  ...
		  for ($i=0; $i < count($unidades); $i++) { 
		  	# code...
$botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarUnidad' idUnidad='".$unidades[$i]["idUnidaddocumental"]."' data-toggle='modal' data-target='#modalEditarUnidad'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarUnidad' idUnidad='".$unidades[$i]["idUnidaddocumental"]."''><i class='fa fa-times'></i></button></div>"; 
							...
							if ($fecha1 == "<strong><p style='color: red'>ELIMINACION</p></strong>") {
								# code...
								$datosJson .= '[
...
$activarUnidades = new TablaUnidadeselim();
$activarUnidades -> mostrarTablaUnidadeselim();
